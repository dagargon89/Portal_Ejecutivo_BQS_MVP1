  ...
  return (
    <nav className="flex items-center justify-between gap-4 pt-3" aria-label="Paginación">
      ...
      <div className="flex items-center gap-2">
        <button className={cn(btn)} onClick={() => onPage(page - 1)} disabled={page <= 1} aria-label="Página anterior">
        ...
        <button className={cn(btn)} onClick={() => onPage(page + 1)} disabled={page >= total_pages} aria-label="Página siguiente">
