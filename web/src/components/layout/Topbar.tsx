/* Barra superior del panel. Toggle de menú (móvil), candado de solo-lectura
 * (Dirección) y menú de usuario con cierre de sesión. */
...
export function Topbar({ onMenu }: { onMenu: () => void }) {
  const { usuario, isReadOnly, logout } = useSession()
